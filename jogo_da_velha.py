...
#Alunos:
#Bernardo Jorge Faria Pereira
#João Vitor Teixeira
#Sidney Augusto Lopes da Silva 
...
def inputPlayerLetter():
	...
	while not(letter == 'X' or letter == 'O'):
		...
		if(letter != 'X' and letter != 'O'):
			print("ERRO! Entre apenas com a letra X(xis) se voce quer ser X ou com a letra O(oh) se voce quer ser O!")
...
def getPlayerMove(board):
	...
	while move not in '1 2 3 4 5 6 7 8 9'.split() or not isSpaceFree(board, int(move)):
		print('Qual e o seu proximo movimento? (1-9)')
		move = input();
		if(move not in '1 2 3 4 5 6 7 8 9'):
			print ("Movimento invvalido! Insira um número entre 1 e 9!")
		
		if(move in '1 2 3 4 5 6 7 8 9'):
			if(not isSpaceFree(board, int(move))):
				print ("Espaco indisponivel! Verifique um espaco vazio e escolha seu numero!")
